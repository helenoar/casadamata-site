        ...
        <div className="backdrop-blur-sm bg-off-2/40 border border-terracota/20 rounded-lg p-6 md:p-8 mb-20">
          ...
          <div className="mt-14 grid grid-cols-2 md:grid-cols-3 gap-3">
            {ILLUSTRATION_PHOTOS.map((photo) => (
              <div
                key={photo.src}
                className="h-[220px] md:h-[280px] overflow-hidden border-t-[3px] border-terracota shadow-soft hover:shadow-lifted hover:-translate-y-1 transition-all duration-300 will-change-transform"
              >
                <Image
                  src={photo.src}
                  alt={photo.alt}
