  ...
  return (
    <header className="flex w-full flex-wrap items-center justify-between gap-4 border-b border-terracota/30 px-6 py-6 md:px-16 lg:px-24">
      <div className="flex items-center gap-3">
        {/* Logo real tem margem branca ao redor do emblema (export de guia de
            marca) — object-cover + scale dentro de um container circular com
            overflow hidden recorta só o emblema, sem editar o PNG original. */}
        <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full bg-off-1 md:h-16 md:w-16">
          <Image
        ...
        {/* "45" não está no logo — placa à parte para reforçar o número da casa no condomínio */}
