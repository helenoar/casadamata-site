  ...
  return (
    <section id="reservar" className="w-full px-6 py-28 text-center md:px-16 lg:px-24">
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        className="inline-block backdrop-blur-xs bg-off-1/50 border border-terracota bg-oliva-escuro px-10 py-5 text-sm tracking-wide text-off-2 uppercase shadow-soft hover:shadow-lifted transition-shadow duration-300"
      >
        Reservar no Airbnb
      </a>
    </section>
